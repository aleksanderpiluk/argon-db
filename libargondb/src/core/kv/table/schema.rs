...
impl Schema {
    const MAX_COLUMNS_IN_TABLE: u16 = u16::MAX - 1;
}
...
//     pub fn lookup_by_name(&self, column_name: impl AsRef<str>) -> Option<&KVColumnSchema> {
//         let Some(column_id) = self.column_name_map.get(column_name.as_ref()) else {
//             return None;
//         };
...
// impl Display for KVTableSchemaBuildError {
//     fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
//         let kind = match self {
//             Self::ColumnCountZero => "ColumnCountZero",
//             Self::ColumnCountExceeded => "ColumnCountExceeded",
//             Self::ColumnsSchemaInvalid => "ColumnsSchemaInvalid",
//             Self::PrimaryKeyColumnCountZero => "PrimaryKeyColumnCountZero",
//             Self::PrimaryKeyColumnCountExceeded => "PrimaryKeyColumnCountExceeded",
//             Self::PrimaryKeyInvalid => "PrimaryKeyInvalid",
//         };

//         write!(f, "KVTableSchemaBuildError - {}", kind)
//     }
// }

// impl std::error::Error for KVTableSchemaBuildError {}
